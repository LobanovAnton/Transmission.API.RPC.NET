...
namespace Transmission.API.RPC
{
    ...
    public interface ITransmissionClientAsync
    {
        ...
        Task<AddTorrentInfo> TorrentAddAsync(NewTorrent torrent);
        ...
        Task<TransmissionTorrents> TorrentGetAsync(string[] fields, object[] ids);
        ...
        Task GroupSet(Group group);

        Task<GroupsInfo> GroupGet(string groupName);
    }
}
